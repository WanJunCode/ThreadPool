...
public:
    ...
    static void toTicks(int64_t& result, int64_t secs, int64_t oldTicks, int64_t oldTicksPerSec, int64_t newTicksPerSec) {
     ...
     */
    static void toTicks(int64_t& result, const struct timespec& value, int64_t ticksPerSec) {
